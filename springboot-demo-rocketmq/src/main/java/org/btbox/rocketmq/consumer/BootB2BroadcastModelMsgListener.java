...
// )
// public class BootB2BroadcastModelMsgListener implements RocketMQListener<MessageExt> {
//
//
//     @Override
//     public void onMessage(MessageExt message) {
//         System.out.println("我是model-cluster-group-b组的第二个消费者: " + new String(message.getBody()));
//     }
// }